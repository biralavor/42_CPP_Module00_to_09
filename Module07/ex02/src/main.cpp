...
/*   Updated: 2026/01/25 10:37:26 by umeneses         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void) {
    ...
    std::cout << "Creating a copy of the Array using the copy constructor." << std::endl;
    Array<int> copy(arr);
    ...
    std::cout << "Assigning the original array to the copy using the assignment operator." << std::endl;
    copy = arr;
